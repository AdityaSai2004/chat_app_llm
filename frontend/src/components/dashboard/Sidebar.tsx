...
export default function Sidebar({ onCreateRoom }: SidebarProps) {
  ...
  return (
    <aside className="w-64 h-full bg-slate-800 border-r border-slate-700 flex flex-col">
      ...
      <div className="p-4 lg:p-6 border-b border-slate-700">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-white font-medium text-sm lg:text-base">Sophia</h3>
            <p className="text-xs lg:text-sm text-green-400">Online</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 lg:px-4 py-4 lg:py-6">
        ...
        <div className="mt-6 lg:mt-8">
          <button
            ...
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 lg:py-3 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-800 text-sm lg:text-base"
          >
            Create Room
          </button>
        </div>
